...
export type StorageHash =
  StorageHashBase<'77275ae636bcc4167a40bb40494f341da5498306738691f760ddfe99b5f4fe23'>;
export type ExecutionHash =
  ExecutionHashBase<'f3400a8568758b0586eeffc3e743c3cd8f25a3dcb4026437050bc0249a4a6d9a'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Device: {
      ...
      readonly deviceType: 'ESP32' | 'ESP8266';
      readonly hardwareId: CodecTypes['pg/text@1']['output'] | null;
      readonly isPaired: CodecTypes['pg/bool@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly Device: {
      ...
      readonly deviceType: 'ESP32' | 'ESP8266';
      readonly hardwareId: CodecTypes['pg/text@1']['input'] | null;
      readonly isPaired: CodecTypes['pg/bool@1']['input'];
...
export type StorageColumnTypes = {
  readonly public: {
    ...
    readonly devices: {
      ...
      readonly device_type: 'ESP32' | 'ESP8266';
      readonly hardware_id: CodecTypes['pg/text@1']['output'] | null;
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly is_active: CodecTypes['pg/bool@1']['output'];
      readonly is_paired: CodecTypes['pg/bool@1']['output'];
      readonly last_seen_at: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
      readonly name: CodecTypes['pg/text@1']['output'];
      readonly name_key: CodecTypes['pg/text@1']['output'];
      readonly project_id: CodecTypes['pg/text@1']['output'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly devices: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [
                { readonly columns: readonly ['hardware_id'] },
                { readonly columns: readonly ['project_id', 'name_key'] },
              ];
              indexes: readonly [
                {
                  readonly name: 'devices_project_id_idx_6ad92603';
                  readonly prefix: 'devices_project_id_idx';
                  readonly columns: readonly ['project_id'];
                  readonly unique: false;
                },
                {
                  readonly name: 'devices_created_by_id_idx_2b1d9a03';
                  readonly prefix: 'devices_created_by_id_idx';
          ...
          readonly valueSet: {
            readonly DeviceType: {
              ...
              readonly values: readonly ['ESP32', 'ESP8266'];
            };
            readonly RoomRole: {
              readonly kind: 'valueSet';
      ...
      readonly public: {
          ...
          readonly Device: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly deviceType: { readonly column: 'device_type' };
                readonly hardwareId: { readonly column: 'hardware_id' };
                readonly isPaired: { readonly column: 'is_paired' };
        ...
        readonly enum: {
          ...
          readonly DeviceType: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'ESP32'; readonly value: 'ESP32' },
              { readonly name: 'ESP8266'; readonly value: 'ESP8266' },
            ];
          };
        };
      };
